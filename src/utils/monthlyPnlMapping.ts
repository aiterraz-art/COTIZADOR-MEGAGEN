...
export const MONTHLY_PNL_SOURCE_ACCOUNT_MAPPINGS: MonthlyPnlSourceAccountMapping[] = [
  ...
  { sourceCode: '4.5.1040.10.05', sourceName: 'ASIGNACION HERRAMIENTAS', sourceKind: 'detail', targetKey: 'employee_benefits' },
  { sourceCode: '4.5.1040.10.06', sourceName: 'VIATICOS', sourceKind: 'detail', targetKey: 'travel_and_transportation_expense' },
  { sourceCode: '4.5.1030.10.13', sourceName: 'COMBUSTIBLES Y LUBRICANTES', sourceKind: 'detail', targetKey: 'vehicle_maintenance_expense' },
  { sourceCode: '4.5.1030.10.30', sourceName: 'GTOS. MENORES VEHICULOS', sourceKind: 'detail', targetKey: 'vehicle_maintenance_expense' },
  ...
  { sourceCode: '4.5.1030.10.25', sourceName: 'PATENTES Y CONTRIBUCIONES', sourceKind: 'detail', targetKey: 'taxes_and_dues' },
  ...
  { sourceCode: '4.5.1030.10.19', sourceName: 'GTOS. NOTARIALES', sourceKind: 'detail', targetKey: 'professional_fee' },
  ...
  { sourceCode: '4.5.1030.10.27', sourceName: 'ROPA DE TRABAJO Y EPP', sourceKind: 'detail', targetKey: 'other_sga_expense' },
  { sourceCode: '4.5.1030.10.28', sourceName: 'GASTOS DE CAPACITACION', sourceKind: 'detail', targetKey: 'training_and_education_expense' },
  ...
  { sourceCode: '4.5.1030.10.33', sourceName: 'GTOS. AUTOPISTAS', sourceKind: 'detail', targetKey: 'travel_and_transportation_expense' },
  { sourceCode: '4.5.1030.10.10', sourceName: 'GTOS. DE REPRESENTACION', sourceKind: 'detail', targetKey: 'entertainment_expense' },
  { sourceCode: '4.5.1030.10.11', sourceName: 'GTOS. DE PUBLICIDAD', sourceKind: 'detail', targetKey: 'advertising_and_marketing_expense' },
  { sourceCode: '4.5.1030.10.29', sourceName: 'GTOS. COMISION MEDIOS DE PAGO', sourceKind: 'detail', targetKey: 'merchant_fees_expense' },
  { sourceCode: '4.5.1030.10.31', sourceName: 'GTOS. INFORMES COMERCIALES', sourceKind: 'detail', targetKey: 'commercial_credit_report_fees' },
  { sourceCode: '4.5.1030.10.98', sourceName: 'GASTOS SIN COMPROBANTES', sourceKind: 'detail', targetKey: 'misc_non_deductible_expenses' },
  { sourceCode: '4.5.1050.10.04', sourceName: 'CASTIGO DE EXISTENCIAS', sourceKind: 'detail', targetKey: 'inventory_write_off' },
  { sourceCode: '4.5.1050.10.07', sourceName: 'IVA NO RECUPERABLE', sourceKind: 'detail', targetKey: 'taxes_and_dues' },
  { sourceCode: '4.5.1040.10.11', sourceName: 'INDEMNIZACION VACACIONES', sourceKind: 'detail', targetKey: 'accrued_vacation_expense' },
  { sourceCode: '4.5.1040.10.12', sourceName: 'INDEMNIZACION SUSTITUTIVA AVISO PREVIO', sourceKind: 'detail', targetKey: 'provision_for_severance_indemnities' },
  { sourceCode: '3.5.1070.10.01', sourceName: 'DIFERENCIA DE CAMBIO', sourceKind: 'detail', targetKey: 'gain_fx_transactions' },
  { sourceCode: '4.5.1090.10.01', sourceName: 'DIFERENCIA DE CAMBIO', sourceKind: 'detail', targetKey: 'loss_fx_transactions' },
  { sourceCode: '3.5.1080.80.02', sourceName: 'REAJUSTE CREDITO FISCAL', sourceKind: 'detail', targetKey: 'miscellaneous_income' },
  { sourceCode: '4.5.1070.10.04', sourceName: 'INTERESES Y MULTAS FISCALES', sourceKind: 'detail', targetKey: 'miscellaneous_loss' },
  { sourceCode: '4.5.1070.10.05', sourceName: 'REAJUSTE ART 72.', sourceKind: 'detail', targetKey: 'miscellaneous_loss' },
];
