...
export const MONTHLY_BALANCE_SOURCE_ACCOUNT_MAPPINGS: MonthlyBalanceSourceAccountMapping[] = [
  ...
  { sourceCode: '1.2.1210.30.06', sourceName: 'EQUIPOS ELECTRONICOS', sourceKind: 'detail', targetKey: 'computer_equipment_other' },
  ...
  { sourceCode: '1.2.1210.70.06', sourceName: 'D.A EQUIPOS ELECTRONICOS', sourceKind: 'detail', targetKey: 'accumulated_depreciation_me' },
